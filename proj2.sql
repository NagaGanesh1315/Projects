...
-- Load all the above tables with data obtained from the corresponding txt file using the 'copy' command
-- Please remember to modify the path to your files accordingly
\copy teams from '/Users/minhpham/Downloads/Proj2/teams.txt' with delimiter ','
\copy coaches_season from '/Users/minhpham/Downloads/Proj2/coaches_season.txt' with delimiter ','
\copy players from '/Users/minhpham/Downloads/Proj2/players.txt' with delimiter ','
\copy player_rs from '/Users/minhpham/Downloads/Proj2/player_rs.txt' with delimiter ','
\copy player_rs_career from '/Users/minhpham/Downloads/Proj2/player_rs_career.txt' with delimiter ','
\copy draft from '/Users/minhpham/Downloads/Proj2/draft.txt' with delimiter ','


-- Put your SQL statement after this line
